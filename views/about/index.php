...
<section class="bg-white rounded-2xl shadow-sm overflow-hidden mb-6">
    <div class="about-hero__overlay p-8 grid md:grid-cols-2 gap-4 items-center" style="background: linear-gradient(120deg, rgba(255,255,255,0.6), rgba(255,255,255,0.52)), url('https://images.unsplash.com/photo-1493809842364-78817add7ffb?auto=format&fit=crop&w=1600&q=95') center/cover no-repeat;">
        <div>
