...
<section class="bg-white rounded-2xl shadow-sm overflow-hidden mb-6">
    <div class="about-hero__overlay p-8 grid md:grid-cols-2 gap-4 items-center" style="background: linear-gradient(120deg, rgba(255,255,255,0.92), rgba(255,255,255,0.86)), url('https://images.unsplash.com/photo-1493809842364-78817add7ffb?auto=format&fit=crop&w=1200&q=80') center/cover no-repeat;">
        <div>
