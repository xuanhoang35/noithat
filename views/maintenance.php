...
<body class="bg-slate-950 text-white flex items-center justify-center px-4 relative overflow-hidden">
    ...
    <img src="<?php echo asset_url('public/bank/noithat1_logo.png'); ?>" alt="Nội Thất Store" class="absolute -top-8 md:-top-10 left-1/2 -translate-x-1/2 z-10 h-[22rem] md:h-[26rem] w-auto object-contain drop-shadow-[0_12px_32px_rgba(0,0,0,0.4)]" onerror="this.style.display='none';">
